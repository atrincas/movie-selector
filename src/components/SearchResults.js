...
class SearchResults extends Component {
	...
	componentDidMount() {
		...
		axios.get('https://api.themoviedb.org/3/configuration?api_key=***REMOVED***&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1')
		...
		// //Fetch Movies:
		// axios.get('https://api.themoviedb.org/3/discover/movie?api_key=***REMOVED***&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1')
